...
class PwSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for page_number in range(1, total_pages + 1):
            page_url = f"https://repo.pw.edu.pl/globalResultList.seam?r=author&tab=PEOPLE&lang=en&p=mcf&qp=academicDegree%253Aterm%253D%2526member%253D%2526team%253D%2526otheractivity%253D%2526specialization%253Aterm%253D%2526activityDiscipline%253Aterm%253D%2526authorprofile_keywords%253D&pn=1"
    ...
    def parse_page(self, response):
        ...
        base_url = "https://repo.pw.edu.pl/globalResultList.seam?r=author&tab=PEOPLE&lang=en&p=amj&qp=academicDegree%253Aterm%253D%2526member%253D%2526team%253D%2526otheractivity%253D%2526specialization%253Aterm%253D%2526activityDiscipline%253Aterm%253D%2526authorprofile_keywords%253D&pn=1"
